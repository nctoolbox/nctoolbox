...
%OPENSEARCH Queries GI-cat using the OpenSearch-geo interface
...
%
% Example 1:
% q.endpoint='http://geoport.whoi.edu/gi-cat/services/opensearchgeo';
...
% [links,params,request_url]=opensearch(q);   % make the query
% dap=links2dap(links); % find only the OPeNDAP links
%
% Example 2:
% q.endpoint='http://testbedapps.sura.org/gi-cat/services/opensearchgeo';
...
if nargout>2,
    ...
    for i=1:2:length(params)
        ...
        requesturl = [requesturl separator param '=' value];
    end
end
